...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawQuality(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            bool disableGroup =  serialized.upscalingFilter.GetEnumValue<UpscalingFilterSelection>() != UpscalingFilterSelection.CasUpsampling;
            EditorGUI.BeginDisabledGroup(disableGroup);
            EditorGUI.indentLevel++;
            serialized.casSharpness.floatValue = EditorGUILayout.Slider(Styles.contrastAdaptiveSharpness, serialized.casSharpness.floatValue, 0.0f, 1.0f);
            EditorGUI.indentLevel--;
            EditorGUI.EndDisabledGroup();
        }
